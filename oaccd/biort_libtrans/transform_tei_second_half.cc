                                             ...
                                             const std::shared_ptr<MOSpace> s3, const std::shared_ptr<MOSpace> s4)
{
    ...
    SharedMatrix c3a = laMOCoefficients_[s3->label()];
    SharedMatrix c3b = lbMOCoefficients_[s3->label()];
    SharedMatrix c4a = raMOCoefficients_[s4->label()];
    SharedMatrix c4b = rbMOCoefficients_[s4->label()];
